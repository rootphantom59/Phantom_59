...
# All files are in the same directory as phantom_setup.sh
OBJ="$DIR"
...
if [ -f "$ZSHRC" ]; then
    ...
    echo -e "${Y}[!] Existing .zshrc backed up to .zshrc.phantom.backup${RS}"
...
alias pxunstall="bash $HOME/.phantom/bin/uninstall.sh"
